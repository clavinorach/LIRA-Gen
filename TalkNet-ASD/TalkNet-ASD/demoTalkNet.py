...
# edit
	...
	shutil.copy(os.path.join(args.pycropPath,indexscore+".avi"), os.path.join(str(alamatparent.parent),"hasil.mp4"))
	# os.system("cp "+args.pycropPath+"/"+indexscore+".avi"+" "+str(alamatparent.parent)+"/hasil.mp4")
	# print("cp "+args.pycropPath+"/"+indexscore+".avi"+" "+str(alamatparent.parent)+"/hasil.mp4")
